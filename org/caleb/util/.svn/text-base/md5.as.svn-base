class org.caleb.util.md5
{
	...
	*/
	...
	private static function coreMD5(x)
	{
			var a = 1732584193;
			var b = -271733879;
			var c = -1732584194;
	...
	private static function strw2binl(str)
	{
	...
	private static function hexMD5(str){ return binl2hex(coreMD5(str2binl(str)))};
	private static function hexMD5w(str){  return binl2hex(coreMD5(strw2binl(str)))};
	private static function b64MD5(str){ return binl2b64(coreMD5(str2binl(str)))};
	private static function b64MD5w(str){ return binl2b64(coreMD5(strw2binl(str)))};
	private static function calcMD5(str){ return binl2hex(coreMD5(str2binl(str)))};
}